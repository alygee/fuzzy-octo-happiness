...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['FuturaPT', 'system-ui', 'sans-serif'],
      },
      fontSize: {
      ...
      backgroundImage: {
        'morning-light':
          'radial-gradient(157.77% 168.58% at 0% 2.5%, #EBE7F8 0%, #FDDAD8 100%)',
      },
      boxShadow: {
        'elevation-1':
          '0px 2px 8px 0px rgba(0, 0, 0, 0.05), 0px 0px 2px 0px rgba(0, 0, 0, 0.03)',
        'elevation-2':
          '0px 4px 16px 0px rgba(0, 0, 0, 0.05), 0px 0px 3px 0px rgba(0, 0, 0, 0.03)',
        'elevation-3':
          '0px 6px 20px 0px rgba(0, 0, 0, 0.06), 0px 0px 6px -1px rgba(0, 0, 0, 0.05)',
        'elevation-4':
          '0px 6px 32px 0px rgba(0, 0, 0, 0.08), 0px 0px 8px -2px rgba(0, 0, 0, 0.05)',
      },
      borderRadius: {
        lg: 'var(--radius)',
